...
<head>
	...
	<title><?php echo $this->session->name; ?> - Scan</title>
...
<body>
	<div class="container my-5">
		...
		<div class="shadow text-bg-light rounded w-100 p-4 mt-3">
			<h2 class="fs-4 fw-bold"><img width="10%" src="images/badge/<?php echo $this->session->image; ?>"> - <?php echo $this->session->name; ?></h2>
			<hr>
	...
	<script>
		$( document ).ready( function() {
			...
			const qrCodeSuccessCallback = ( decodedText, decodedResult) => {
				html5QrCode.pause();
				$.post( 'Cadminl23/postScan', { qrc: decodedText } )
					.done( function( data ) {
						alert( data );
						html5QrCode.resume();
					} );
