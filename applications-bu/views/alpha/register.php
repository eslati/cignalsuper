		...
		<div class="reg-form">
			<form id="regForm" action="" method="POST">
				...
				<div class="mb-5">
					...
					<input type="text" id="mobile" name="mobile" placeholder="09XX XXX XXXX" pattern="09\d{2}\d{3}\d{4}" required>
				</div>
				<div class="pp-checkbox d-flex flex-nowrap justify-content-center align-items-center mb-2">
					...
					<label for="privacy-policy" class="text-light mb-0">I understand and agree to the <a href="#" class="text-light">Privacy Policy</label>
				</div>
