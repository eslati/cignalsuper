...
<?php foreach ($badge as $i) : ?>
			<a href="">
				<img src="images/badge/<?php echo in_array($i['id'], $play) ? '' : 'BW_', $i['image']; ?>" alt="<?php echo $i['name']; ?>">
			</a>
<?php endforeach; ?>
		</div>
		...
		<div class="modal fade" id="qr-modal" tabindex="-1" aria-labelledby="qr-modal-label" aria-hidden="true" onclick="window.location.reload();">
